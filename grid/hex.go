...
func (g *HexGrid) RandomWalkableTile() (int, int) {
...
func (g *HexGrid) RandomWalkableTileWorld() (float32, float32, bool) {
...
func (g *HexGrid) RandomWalkableTileInRadius(cx, cy, radius int) (int, int) {
	for i := 0; i < 50; i++ {
...
func (g *HexGrid) RandomWalkableTileInRadiusWorld(wx, wy float32, radius int) (float32, float32, bool) {
